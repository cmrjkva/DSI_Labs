...
In this lab, you will build, regularize, save, evaluate, iterate on, and compare a neural network model for classification.
...
| --- | --- | --- |
| Activity |  Neural Network Classification Jupyter Notebook | [Link](./7.01-lab-nn-classification-starter.ipynb)|
| Link | Google Colab Home Page | [Link](https://colab.research.google.com/notebooks/intro.ipynb) |
...
- Understand and interpret classification metrics for neural networks
